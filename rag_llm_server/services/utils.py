# rag_llm_server/services/utils.py
import os
import json
import hashlib
import hmac
...
def serialize_json_body(body: Any) -> bytes:
...
class Signer:
    def __init__(self, request_data, service, region='cn-north-1'):
        ...
        self.body_bytes = serialize_json_body(self.body)
    ...
    def add_authorization(self, account_config):
        ...
        # 2. 计算 Body Hash
        body_hash = hashlib.sha256(self.body_bytes).hexdigest()
...
#         "Error": {
#             "Code": -1,
#             "Message": "Custom 不存在, 请先在 Python 后端场景配置中定义该场景." # 异常的具体描述
#         }
#     }
# }
